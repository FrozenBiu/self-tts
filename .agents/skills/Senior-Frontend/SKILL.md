...
description: Frontend development skill for React, Next.js, TypeScript, and Tailwind CSS applications. Use when building React components, optimizing Next.js performance, analyzing bundle sizes, scaffolding frontend projects, implementing accessibility, or reviewing frontend code quality. Enforces strict pnpm management, Sonner notifications (no alert), and modern UI libraries (Shadcn UI, HeroUI, MagicUI).
---

# Senior Frontend Engineer (Next.js & Modern UI)

Frontend development patterns, performance optimization, and automation tools for React/Next.js applications.

> **Tiêu chuẩn bắt buộc:**
> - Quản lý package 100% bằng **`pnpm`** (không dùng `npm` hay `yarn`).
> - **Cấm dùng `alert()`**, bắt buộc dùng thư viện **Sonner** (`toast.success()`, `toast.error()`).
> - Ưu tiên các thư viện UI: **Shadcn UI**, **HeroUI**, **MagicUI**, **Motion-Primitives**, **Pattern Craft**.

## Table of Contents

- [Project Scaffolding (pnpm)](#project-scaffolding)
...
Generate a new Next.js project with TypeScript, Tailwind CSS, and best practice configurations.

### Workflow: Create New Frontend Project (Strictly `pnpm`)

1. Khởi tạo dự án Next.js chuẩn:
   ```bash
   pnpm create next-app@latest my-app --typescript --tailwind --eslint --app --src-dir --import-alias "@/*" --use-pnpm
   ```

2. Cài đặt các gói UI và thông báo Sonner:
   ```bash
   cd my-app
   pnpm add sonner lucide-react clsx tailwind-merge class-variance-authority
   ```
